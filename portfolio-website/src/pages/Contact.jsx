            ...
            >
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social, index) => (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.9 }}
                      className="w-12 h-12 bg-white rounded-lg shadow-lg hover:shadow-xl flex items-center justify-center text-gray-600 hover:text-primary-600 hover:bg-primary-50 transition-all duration-300"
                    >
              ...
              >
                <div className="flex items-center mb-2">
                  ...
                  <h3 className="font-semibold text-green-800">Available for Projects</h3>
                </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Here are some common questions I get. Don't see your question? Feel free to ask!
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                answer: "I usually respond to messages within 24 hours, often much sooner. For urgent matters, don't hesitate to mention it in your message."
              },
              {
                question: "What types of projects do you work on?",
                answer: "I specialize in web development projects including React applications, full-stack solutions, API development, and mobile apps. I'm always excited about new challenges!"
              },
              {
                question: "Do you work with international clients?",
                answer: "Absolutely! I've worked with clients from various time zones and am comfortable with remote collaboration using modern communication tools."
              },
              {
                question: "What's your preferred way to communicate?",
                answer: "I'm flexible with communication methods. Email is great for initial contact, and I'm happy to use video calls, Slack, or whatever works best for your team."
              }
            ].map((faq, index) => (
              <motion.div
                key={index}
