              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className={`w-full flex items-center justify-center px-8 py-4 text-lg font-medium text-white rounded-lg transition-all duration-300 ${
                      isSubmitting 
                ...
                {submitStatus === 'success' && (
                  <motion.div
                    ...
                    className="flex items-center p-4 bg-green-100 border border-green-200 text-green-700 rounded-lg"
                  >
                ...
                <div className="grid grid-cols-2 gap-4">
                  {socialLinks.map((social, index) => (
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="flex items-center justify-center p-4 bg-gray-50 rounded-lg hover:bg-primary-50 hover:text-primary-600 transition-all duration-300 group"
                    >
